                ...
                <Box className='box1'>
                    ...
                    <Box display="flex" alignItems="center" justifyContent="center" paddingBottom={3} paddingTop={3} className="borda">
                        <Box marginRight="auto" marginBottom="auto" paddingLeft={7}>
                            <Typography variant='h6' align="right" gutterBottom className="justify titulos-footer">Produtos</Typography>
                        ...
                        <Box marginRight="auto" marginBottom="auto" paddingLeft={16}>
                            <Typography variant='h6' align="right" gutterBottom className="justify titulos-footer">Ajuda</Typography>
                        ...
                        <Box marginRight="auto" marginBottom="auto" paddingLeft={16}>
                            <Typography variant='h6' align="right" gutterBottom className="justify titulos-footer">Para ler</Typography>
                        ...
                        <Box marginRight="auto" marginBottom="auto" paddingLeft={16}>
                            ...
                            <Typography variant='h6' align="right" gutterBottom className="justify titulos-footer">Atendimento</Typography>
